...
const styles = StyleSheet.create({
  background: { flex: 1, backgroundColor: "rgba(0,0,0,0.915)" },
  ...
  locationText: { fontSize: 13, color: "#fff", marginVertical: 2 },
  ratingRow: { flexDirection: "row" },
  valueContainer: { alignItems: "flex-end" },
  valueText: { fontSize: 16, fontWeight: "700", color: "#85bb65" },
  requestContainer: { marginTop: 4 },
  requestText: { fontSize: 14, color: "#fff", fontWeight: "500" },
  feedbackRow: { flexDirection: "column" },
  feedbackItem: { flexDirection: "row", marginBottom: 6 },
  feedbackName: { fontSize: 14, fontWeight: "500", marginRight: 6, color: "#fff" },
  starsContainer: { flexDirection: "row" },
  profileSection: { flexDirection: "row", alignItems: "center" },
  profileImageLarge: { width: 64, height: 64, borderRadius: 12, marginRight: 12 },
  profileInfo: { flex: 1 },
  profileDetail: { fontSize: 13, color: "#fff", marginTop: 2 },
  bottomBar: {
    position: "absolute",
    left: 0,
    right: 0,
