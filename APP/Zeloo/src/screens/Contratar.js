...
import { View, Text, TouchableOpacity,Dimensions, TextInput,Platform, StyleSheet, Image, ScrollView } from 'react-native';
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={{
        ...
        <View style={styles.cardRow}>
            <Image source={require('../../assets/images/perfil.png')} style={styles.cuidador} />
            
            <View style={styles.cuida}>
            <Text style={styles.cardText}>Nome Sobrenome</Text>
